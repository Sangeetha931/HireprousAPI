...
//		}
	...
	private ResourceAccomplishmentDto getResourceAccomplishmentDto(ResourceAccomplishment resourceAccomplishment, int index) {
...
//		resourceAccomplishmentDto.setRoleName(role.getRoleName());
	...
	public ResourceAccomplishmentDto getResourceAccomplishmentById(Long id) throws Exception {
		...
		if (resourceAccomplishment != null) {
			index++;
			resourceAccomplishmentDto = getResourceAccomplishmentDto(resourceAccomplishment, index);
		} else {
